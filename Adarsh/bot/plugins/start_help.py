...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<b>ꜱᴏᴍᴇᴛʜɪɴɢ  ᴡᴇɴᴛ  ᴡʀᴏɴɢ  <a href='https://t.me/TMR_DEVELOPER'>ᴄʟɪᴄᴋ  ʜᴇʀᴇ  ꜰᴏʀ  ꜱᴜᴘᴘᴏʀᴛ</a></b>",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ [ᴏᴡɴᴇʀ](https://t.me/TMR_DEVELOPER).",
                disable_web_page_preview=True)
            return
...
┣⪼<b>ᴜᴘᴅᴀᴛᴇꜱ : <a href='https://t.me/TMR_update_channel'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>
┣⪼<b>ᴏᴡɴᴇʀ : <a href='https://t.me/TMR_DEVELOPER'>🧑‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ</a></b>
┃
<b>╰━━━━〔ᴘʟᴇᴀꜱᴇ sᴜᴘᴘᴏʀᴛ〕</b>""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("💥  ᴜᴘᴅᴀᴛᴇꜱ", url="https://t.me/TMR_update_channel")]
            ]
        )
    )
